...
function sendOTPEmail($toEmail, $otp, $userName = '') {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'truongnguyen1714@gmail.com'; // ⚠️ THAY ĐỔI EMAIL CỦA BẠN
        $mail->Password   = 'qqma eldm bgxo eiis';    // ⚠️ THAY ĐỔI APP PASSWORD (không phải mật khẩu Gmail)
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;
        $mail->CharSet    = 'UTF-8';

        // Người gửi
        $mail->setFrom('truongnguyen1714@gmail.com', 'App Bán Đồng Hồ'); // ⚠️ THAY ĐỔI
