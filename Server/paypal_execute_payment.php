...
try {
    ...
    if ($captureData['status'] == 'COMPLETED') {
        // ✅ SỬA: Đổi trạng thái thành "Đã thanh toán" giống VNPay
        $stmt = $conn->prepare("UPDATE donhang SET trangthai = 'Đã thanh toán', paypal_payer_id = ?, paypal_payment_date = NOW() WHERE madonhang = ?");
